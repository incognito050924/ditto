...
Issues and PRDs for this repo live as GitHub issues on `incognito050924/ditto`. Use the `gh` CLI for all operations. This is consistent with the repo's backlog SoT decision (ADR-20260628-github-backlog-sot: backlog = GitHub read, completion = ditto write).
...
Used by `/wayfinder`. The **map** is a single issue with **child** issues as tickets. This repo has GitHub sub-issues enabled.
