...
7. **Self-check before returning.** Run `ditto e2e conformance --journey <journey.md> --generated <spec.ts>` for each converted journey and fix any missing/stale finding yourself before reporting.
